<template>
    <div id="tambah-karyawan" class="font-poppins flex justify-center py-12 bg-base-200 bg-gray-100">
        <div class="md:w-1/3 px-10 py-10 bg-white shadow-lg rounded-xl">
            <h1 class="text-2xl font-semibold text-green-700 text-center mb-6">Edit Data Diri</h1>
            ...
            <router-link :to="'/profile/'+user._id" v-if="oke" class="fixed inset-0 flex justify-center items-center w-full h-full" @click="oke = false">
