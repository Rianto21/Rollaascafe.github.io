<template>
    <Navbar />
    <div id="keranjang" class="px-32 py-16 w-full gap-8 flex flex-col items-center">
                ...
                <tr class="border-2 border-green-700 py-4 px-6 rounded-lg flex justify-between items-center">
                    ...
                    <td class="flex gap-8 items-center">
                        <div class="flex gap-3 items-center">
                            <div class="bg-green-700 text-white rounded-md py-2 px-4 text-lg" :class="[cart.jumlah_barang > 1 ? 'cursor-pointer' : 'cursor-default']" @click="cart.jumlah_barang > 1 ? cart.jumlah_barang-- : cart.jumlah_barang = cart.jumlah_barang">-</div>
                            <div class="text-xl text-green-700 font-semibold">{{cart.jumlah_barang}}</div>
                            <div class="bg-green-700 text-white rounded-md py-2 px-4 text-lg cursor-pointer" @click="cart.jumlah_barang++">+</div>
                        </div>
        ...
        <div class="w-full flex justify-end text-2xl font-semibold gap-4 items-center">Total Harga : <span class="border-2 rounded-md border-green-500 text-green-500 py-2 px-6">Rp. 18.000</span></div>
        div
    </div>
</template>
